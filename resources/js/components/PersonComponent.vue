                ...
                <div id="people">
                    <v-client-table :data="people" :columns="columns" :options="options" :show-sort-icons="true">
                        ...
                        <template  slot="definite_employment" slot-scope="props">
                            <i v-if="props.row.definite_employment='true'" class="fa fa-check-square" ></i>
                        ...
                        <template slot="buttons" slot-scope="props">
                            <div class="table-button-container">
                                ...
                                <!--Delete-->
                                <button class="edit-modal btn btn-danger btn-sm" @click.prevent="deletePerson(props.row)">
                                    Delete
                                </button>
                                ...
                                <!--<button v-else="props.row.user===null"-->
                                        <!--@click="props.row.showModal_users = true"-->
                                        <!--class="edit-modal btn btn-outline-secondary btn-sm">Edit User-->
                                <!--</button>-->
                            </div>
                        </template>
